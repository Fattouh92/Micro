        	...
        	startAddress =Integer.parseInt(st_addr.getText());
                ...
                double perc;
                   ...
                   case 2:
                	   ...
                	   textarea.append("Level 2 : "+(cache.hit2 / (cache.hit2 + cache.miss2)));
                     System.out.println("Cache Hit ratio: ");
                  ...
                  case 3:
                   textarea.append("Cache Hit ratio :");
               	   textarea.append("Level 1 : "+(cache.hit / (cache.hit + cache.miss)));
               	   textarea.append("Level 2 : "+(cache.hit2 / (cache.hit2 + cache.miss2)));
                   textarea.append("Level 3 : "+(cache.hit3 / (cache.hit3 + cache.miss3)));
                    System.out.println("Cache Hit ratio: ");
                     System.out.println("Level1: "
                       + (cache.hit / (cache.hit + cache.miss)));
                    System.out.println("Level2: "
                   ...
                   switch (icacheLevels) {
                   case 1:
                	textarea.append("Instruction Cache Hit ratio: : "+(icache.hit / (icache.hit + icache.miss)));
                    System.out.println("Instruction Cache Hit ratio: "
                       + (icache.hit / (icache.hit + icache.miss)));
                     break;
                   case 2:
                	   textarea.append("Instruction Cache Hit ratio:  ");
                	   textarea.append("Level 1:  "+(icache.hit / (icache.hit + icache.miss)));
                	   textarea.append("Level 2:  "+(icache.hit2 / (icache.hit2 + icache.miss2)));
                    System.out.println("Instruction Cache Hit ratio: ");
                    System.out.println("Level1: "
                        + (icache.hit / (icache.hit + icache.miss)));
                    System.out.println("Level2: "
                  ...
                  case 3:
                   ...
                   textarea.append("Level 1:  "+(icache.hit / (icache.hit + icache.miss)));
               	   textarea.append("Level 2:  "+(icache.hit2 / (icache.hit2 + icache.miss2)));
               	 textarea.append("Level 3:  "+(icache.hit3 / (icache.hit3 + icache.miss3)));
                    System.out.println("Instruction Cache Hit ratio: ");
                    System.out.println("Level1: "
                         + (icache.hit / (icache.hit + icache.miss)));
                     System.out.println("Level2: "
